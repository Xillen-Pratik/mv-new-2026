        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-left text-white max-w-xxl">
            ...
            <div className="w-full sm:inline-flex">
              <Link
                href="#"
                className="inline-flex w-full sm:w-auto items-center justify-center px-8 py-4 text-base font-bold text-white rounded-lg transition-opacity hover:opacity-95 min-w-[200px]"
          ...
          <div className="relative h-[380px] lg:h-[480px] w-full flex items-center justify-center lg:justify-end">
            <Image
              src="/images/Group 1000007080.png"
